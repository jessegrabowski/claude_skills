...
- File -- a file with mixed concerns must be split (see section 3).
...
1. Stage exactly what belongs to it -- `git add <files>` when every hunk of a file belongs to this commit, otherwise the write-the-state approach from section 3.
